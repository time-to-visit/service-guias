...
type Guides struct {
	Model
	NameGuide          string                     `gorm:"column:sites_name;type:varchar(255);not null" json:"sites_name" validate:"required"`
	...
	Activities         []ActivitiesWihoutValidate `gorm:"foreignKey:GuideId;references:ID"  json:"activities,omitempty"`
}
