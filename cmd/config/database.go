...
func migration() {
	DB.AutoMigrate(&entity.Guides{})
	DB.AutoMigrate(&entity.Activities{})
	DB.AutoMigrate(&entity.ContainerLevels{})
	DB.AutoMigrate(&entity.Objectives{})
	DB.AutoMigrate(&entity.Question{})
	DB.AutoMigrate(&entity.Levels{})
	DB.AutoMigrate(&entity.Section{})
